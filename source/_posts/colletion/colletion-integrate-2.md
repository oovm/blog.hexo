...
&= \sum\limits_{n = 1}^\infty {\int_n^{n + 1} {\frac{1}{{{y^3}}}} } (1 + n)(y - n){\mkern 1mu} dy\\
...
$$\begin{aligned}
\int_0^n {{{ \lceil x \rceil }^p}} {\mkern 1mu} dx &= {n^p} + \frac{{{B_{p + 1}}(n) - {B_{p + 1}}}}{{p + 1}}\\
\int_0^n {{{ \lfloor x \rfloor }^p}} {\mkern 1mu} dx &= \frac{{{B_{p + 1}}(n) - {B_{p + 1}}}}{{p + 1}}\\
\int_0^n {{{ \lfloor x \rceil }^p}} {\mkern 1mu} dx &= \frac{{{n^p}}}{2} + \frac{{{B_{p + 1}}(n) - {B_{p + 1}}}}{{p + 1}}\\
