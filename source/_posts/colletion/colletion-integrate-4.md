...
$$\begin{aligned}
{x^n} &= \frac{{{z^n}}}{{1 + {z^n}}}\\
\mathrm{d}x &= \frac{{\mathrm{d}z}}{{{{(1 + {z^n})}^{1 + 1/n}}}}
\end{aligned}$$
...
$$I(a,b) = \int_0^\infty  {\frac{{{x^{a - 1}}}}{{{x^b} + 1}}} \mathrm{d}x = \frac{\pi }{{b\sin a\pi /b}}$$
...
$$\begin{aligned}
\int_0^\infty\dfrac{x^{\large a-1}}{1+x^b}\mathrm{d}x
&=\frac1b\int_0^1y^{\large1-\frac{a}{b}-1}(1-y)^{\large\frac{a}{b}-1}\mathrm{d}y\\
