...
$$\int_0^1 {\frac{{{x^{1/2}} - {x^{ - 1/2}}}}{{x - 1}}} \mathrm{d}x = 2$$
...
\int_0^1 {\frac{{{x^{ - a}} - {x^a}}}{{1 - x}}} \; \mathrm{d}x &= \sum\limits_{n = 0}^\infty {\int_0^1 {({x^{ - a}} - {x^a})} } {x^n}\; \mathrm{d}x\\
...
$$\int_0^{\frac{\pi }{2}} x {\csc ^2}(x)\arctan \left( {\alpha \tan x} \right)\; \mathrm{d}x = \int_0^\infty  {\frac{{{{\tan }^{ - 1}}u{{\tan }^{ - 1}}\alpha u}}{{{u^2}}}} \; \mathrm{d}u$$

接下来证明这个:

$$\bigstar I(\alpha ,\beta ) = \int_0^\infty  {\frac{{{{\tan }^{ - 1}}\alpha u{{\tan }^{ - 1}}\beta u}}{{{u^2}}}} \; \mathrm{d}u = \frac{\pi }{2}\log \left( {\frac{{{{(\alpha  + \beta )}^{\alpha  + \beta }}}}{{{\alpha ^\alpha }{\beta ^\beta }}}} \right)$$

老样子看看能不能变重积分,不能,那就求偏导:

$$\begin{aligned}
{\partial _\alpha }{\partial _\beta }I(\alpha ,\beta )
&= \int_0^\infty {\frac{{\mathrm{d}u}}{{(1 + {\alpha ^2}{u^2})(1 + {\beta ^2}{u^2})}}} \\
&= \frac{1}{{{\alpha ^2} - {\beta ^2}}}\int_0^\infty {\frac{{{\alpha ^2}}}{{1 + {\alpha ^2}{u^2}}}} - \frac{{{\beta ^2}}}{{1 + {\beta ^2}{u^2}}}\; \mathrm{d}u\\
&= \frac{1}{{{\alpha ^2} - {\beta ^2}}}\int_0^\infty {\frac{\alpha }{{1 + {u^2}}}} - \frac{\beta }{{1 + {u^2}}}\; \mathrm{d}u\\
&= \frac{\pi }{{2(\alpha + \beta )}}
\end{aligned}$$

积α:

$${\partial _\beta }\int_0^\infty  {\frac{{{{\tan }^{ - 1}}\alpha u{{\tan }^{ - 1}}\beta u}}{{{u^2}}}} \; \mathrm{d}u = \frac{\pi }{2}(\log (\alpha  + \beta ) - {C_1}(\beta ))$$
